<h6 class="ml3">Du brauchst Hilfe?</h6>
			...
			<br><br><div id="hilfe">
			           <ul><table cellspacing="0" cellpadding="0" class="t1"><tbody> <td valign="middle" class="td1"><li><h3><a href="irc://moznet/firefox.de"><img src="/img/logos/irc.png" width="58px" height="58px" class="picex" alt="C" />
              
    
      <h3 class="programme programm2">Firefox-Chat</h3>
            </a></h3>
                <a class="button" class="programm3" class="programm4" href="irc://moznet/firefox.de">Betreten</a>
                </li>      </td>
      <td valign="middle" class="td1"><li>
            ...
            <h3 class="programme">Thunderbird</h3>
                ...
                <a class="button" class="programm3" href="http://www.thunderbird-mail.de/forum/">Forum</a>
			</li>      </td>
    </tr>
    <tr>
      <td valign="middle" class="td2">
            ...
            <h3 class="programme">SeaMonkey</h3>
                ...
                <a class="button" class="programm3" href="http://www.seamonkey.at/">Forum</a>
			</li>      </td>
      <td valign="middle" class="td2">
			<li>
            ...
            <h3 class="programme">Lightning</h3>
                ...
                <a class="button" class="programm3" href="http://www.thunderbird-mail.de/forum/viewforum.php?f=46">Forum</a>
			</li>      </td>
    </tr>
    <tr>
      <td valign="middle" class="td2">
            ...
            <h3 class="programme">KompoZer</h3>
                ...
                <a class="button" class="programm3" href="http://www.kompozer-web.de/">Forum</a>
			</li>      </td>
      <td valign="middle" class="td2">
			<li>
			           <h3><a href="http://developer.mozilla.org/de/"><img src="/img/logos/mdn.png" width="50px" height="50px" alt="C" />
            <h3 class="programme">Entwickler</h3>
            </a></h3>
                <a class="button" class="programm3" href="http://developer.mozilla.org/de/">MDN</a>
		</li>      </td>
    </tr>
  </tbody>
</table></ul></div><br>
